...
; Background music
bgm__First:	equ $81
bgm_GHZ:	equ ((ptr_mus81-bgmtb)/4)+bgm__First
bgm_LZ:		equ ((ptr_mus82-bgmtb)/4)+bgm__First
bgm_MZ:		equ ((ptr_mus83-bgmtb)/4)+bgm__First
bgm_SLZ:	equ ((ptr_mus84-bgmtb)/4)+bgm__First
bgm_SYZ:	equ ((ptr_mus85-bgmtb)/4)+bgm__First
bgm_SBZ:	equ ((ptr_mus86-bgmtb)/4)+bgm__First
bgm_Invincible:	equ ((ptr_mus87-bgmtb)/4)+bgm__First
bgm_ExtraLife:	equ ((ptr_mus88-bgmtb)/4)+bgm__First
bgm_SS:		equ ((ptr_mus89-bgmtb)/4)+bgm__First
bgm_Title:	equ ((ptr_mus8A-bgmtb)/4)+bgm__First
bgm_Ending:	equ ((ptr_mus8B-bgmtb)/4)+bgm__First
bgm_Boss:	equ ((ptr_mus8C-bgmtb)/4)+bgm__First
bgm_FZ:		equ ((ptr_mus8D-bgmtb)/4)+bgm__First
bgm_GotThrough:	equ ((ptr_mus8E-bgmtb)/4)+bgm__First
bgm_GameOver:	equ ((ptr_mus8F-bgmtb)/4)+bgm__First
bgm_Continue:	equ ((ptr_mus90-bgmtb)/4)+bgm__First
bgm_Credits:	equ ((ptr_mus91-bgmtb)/4)+bgm__First
bgm_Drowning:	equ ((ptr_mus92-bgmtb)/4)+bgm__First
bgm_Emerald:	equ ((ptr_mus93-bgmtb)/4)+bgm__First
bgm__Last:	equ ((ptr_musend-bgmtb-4)/4)+bgm__First

; Sound effects
sfx__First:	equ $A0
sfx_Jump:	equ ((ptr_sndA0-setb)/4)+sfx__First
sfx_Lamppost:	equ ((ptr_sndA1-setb)/4)+sfx__First
sfx_A2:		equ ((ptr_sndA2-setb)/4)+sfx__First
sfx_Death:	equ ((ptr_sndA3-setb)/4)+sfx__First
sfx_Skid:	equ ((ptr_sndA4-setb)/4)+sfx__First
sfx_A5:		equ ((ptr_sndA5-setb)/4)+sfx__First
sfx_HitSpikes:	equ ((ptr_sndA6-setb)/4)+sfx__First
sfx_Push:	equ ((ptr_sndA7-setb)/4)+sfx__First
sfx_SSGoal:	equ ((ptr_sndA8-setb)/4)+sfx__First
sfx_SSItem:	equ ((ptr_sndA9-setb)/4)+sfx__First
sfx_Splash:	equ ((ptr_sndAA-setb)/4)+sfx__First
sfx_AB:		equ ((ptr_sndAB-setb)/4)+sfx__First
sfx_HitBoss:	equ ((ptr_sndAC-setb)/4)+sfx__First
sfx_Bubble:	equ ((ptr_sndAD-setb)/4)+sfx__First
sfx_Fireball:	equ ((ptr_sndAE-setb)/4)+sfx__First
sfx_Shield:	equ ((ptr_sndAF-setb)/4)+sfx__First
sfx_Saw:	equ ((ptr_sndB0-setb)/4)+sfx__First
sfx_Electric:	equ ((ptr_sndB1-setb)/4)+sfx__First
sfx_Drown:	equ ((ptr_sndB2-setb)/4)+sfx__First
sfx_Flamethrower:equ ((ptr_sndB3-setb)/4)+sfx__First
sfx_Bumper:	equ ((ptr_sndB4-setb)/4)+sfx__First
sfx_Ring:	equ ((ptr_sndB5-setb)/4)+sfx__First
sfx_SpikesMove:	equ ((ptr_sndB6-setb)/4)+sfx__First
sfx_Rumbling:	equ ((ptr_sndB7-setb)/4)+sfx__First
sfx_B8:		equ ((ptr_sndB8-setb)/4)+sfx__First
sfx_Collapse:	equ ((ptr_sndB9-setb)/4)+sfx__First
sfx_SSGlass:	equ ((ptr_sndBA-setb)/4)+sfx__First
sfx_Door:	equ ((ptr_sndBB-setb)/4)+sfx__First
sfx_Teleport:	equ ((ptr_sndBC-setb)/4)+sfx__First
sfx_ChainStomp:	equ ((ptr_sndBD-setb)/4)+sfx__First
sfx_Roll:	equ ((ptr_sndBE-setb)/4)+sfx__First
sfx_Continue:	equ ((ptr_sndBF-setb)/4)+sfx__First
sfx_Basaran:	equ ((ptr_sndC0-setb)/4)+sfx__First
sfx_BreakItem:	equ ((ptr_sndC1-setb)/4)+sfx__First
sfx_Warning:	equ ((ptr_sndC2-setb)/4)+sfx__First
sfx_GiantRing:	equ ((ptr_sndC3-setb)/4)+sfx__First
sfx_Bomb:	equ ((ptr_sndC4-setb)/4)+sfx__First
sfx_Cash:	equ ((ptr_sndC5-setb)/4)+sfx__First
sfx_RingLoss:	equ ((ptr_sndC6-setb)/4)+sfx__First
sfx_ChainRise:	equ ((ptr_sndC7-setb)/4)+sfx__First
sfx_Burning:	equ ((ptr_sndC8-setb)/4)+sfx__First
sfx_Bonus:	equ ((ptr_sndC9-setb)/4)+sfx__First
sfx_EnterSS:	equ ((ptr_sndCA-setb)/4)+sfx__First
sfx_WallSmash:	equ ((ptr_sndCB-setb)/4)+sfx__First
sfx_Spring:	equ ((ptr_sndCC-setb)/4)+sfx__First
sfx_Switch:	equ ((ptr_sndCD-setb)/4)+sfx__First
sfx_RingLeft:	equ ((ptr_sndCE-setb)/4)+sfx__First
sfx_Signpost:	equ ((ptr_sndCF-setb)/4)+sfx__First
sfx__Last:	equ ((ptr_sndend-setb-4)/4)+sfx__First

; Special sound effects
spec__First:	equ $D0
sfx_Waterfall:	equ ((ptr_sndD0-backtb)/4)+spec__First
spec__Last:	equ ((ptr_specend-backtb-4)/4)+spec__First
